          ...
          <main className='mt-14'>
            ...
            <div className='divide-y divide-white/5'>
              <div className='grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8'>
                <div>
                  <h2 className='text-base font-semibold leading-7 dark:text-white'>Personal Information</h2>
                    ...
                    <div className='sm:col-span-3'>
                      ...
                      <div className='mt-2'>
                        <input
                          ...
                          className='block w-full rounded-md border-0 bg-white/5 py-1.5 dark:text-white shadow-sm 
                    ...
                    <div className='sm:col-span-3'>
                      ...
                      <div className='mt-2'>
                        <input
                          ...
                          className='block w-full rounded-md border-0 bg-white/5 py-1.5 dark:text-white shadow-sm ring-1 
                    ...
                    <div className='col-span-full'>
                      ...
                      <div className='mt-2'>
                        <select
                          id='timezone'
                          name='timezone'
                          className='block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1
                          ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 [&_*]:text-black'>
