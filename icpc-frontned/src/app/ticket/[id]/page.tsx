...
Function: fetches ticket data by id, serializes markdown for notes/exercises, renders the appropriate card(s) for the ticket type and operation, 
and displays ticket actions
