...
import { Listbox, ListboxButton, ListboxOptions, ListboxOption, Transition, ListboxSelectedOption } from '@headlessui/react'
    ...
    <div className={classes}>
      ...
      <Listbox
        ...
        <ListboxButton
            ...
            placeholder={
              <span>
                <span className='flex items-center'>
                  <span className='ml-3 block truncate'>{'Elija una opción'}</span>
                </span>
          ...
          <ListboxOptions
            anchor='top'
            className={`absolute z-10 mt-1 max-h-56 w-[var(--button-width)] overflow-auto rounded-md bg-white py-1 text-base 
