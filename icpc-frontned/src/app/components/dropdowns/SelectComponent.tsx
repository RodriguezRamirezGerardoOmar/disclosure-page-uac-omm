    ...
    <div className={classes}>
      ...
      <Listbox
        ...
        {({ open }) => (
          <div className=''>
            <ListboxButton
              className={`relative w-full h-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left 
              ...
              <ListboxSelectedOption
                placeholder={<span className='opacity-50 h-4'>{'Elija una opción'}</span>}
                options={
                  <Transition
                    show={open}
                    as={Fragment}
