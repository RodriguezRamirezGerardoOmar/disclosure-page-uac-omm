          ...
          <div className='lg:col-start-3'>
            ...
            <div className='mt-6 flex gap-x-3'>
              ...
              <form
                ...
                <div
                  className='overflow-hidden rounded-lg pb-12 shadow-sm ring-1 ring-inset 
                        ...
                        {({ open }) => (
                          <>
                            ...
                            <div className='relative'>
                              <Listbox.Button
                                className='relative -m-2.5 flex h-10 w-10 items-center justify-center 
                              ...
                              <Transition
                                ...
                                leaveTo='opacity-0'>
                                <Listbox.Options
                                  className='absolute z-10 -ml-6 mt-1 w-60 rounded-lg bg-white 
                                  py-3 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:ml-auto sm:w-64 sm:text-sm'>
                                  {moods.map(mood => (
                                    <Listbox.Option
                                      key={mood.value}
                                      className={({ active }) =>
                                        classNames(active ? 'bg-gray-100' : 'bg-white', 'relative cursor-default select-none px-3 py-2')
                                      }
                                      value={mood}>
                                      <div className='flex items-center'>
